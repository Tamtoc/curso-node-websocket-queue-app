...
socket.on('actual-state', ( payload ) => {
    ...
    const audio = new Audio('../audio/new-ticket.mp3');     // Chrome bloquea el audio a menos que sea disparado por el usuario (Usar firefox en la pantalla publica)
    audio.play();               
    ...
    if ( ticket4 ) {    
        ...
        lblEscritorio4.innerText = 'Ticket: ' + ticket4.desktop;
    }
});